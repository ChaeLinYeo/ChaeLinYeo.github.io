...
![png](/assets/images/2020-12-21/7.png)  
...
## 탄력적 IP 설정
### 탄력적 IP 생성
![png](/assets/images/2020-12-21/8.png)  
...
![png](/assets/images/2020-12-21/9.png)  
고정 IP를 받을 수 있는 창이 뜬다. "할당"을 클릭한다.  

### 탄력적 IP를 인스턴스에 연결
![png](/assets/images/2020-12-21/10.png)  
"할당"을 클릭하면 다음과 같은 페이지로 이동한다.  
할당 받은 IP는 3.35.46.177로 할당받았다.  
이렇게 생성한 탄력적 IP를 기 생성한 인스턴스의 IP 주소로 사용하기 위해 연결한다.  
![png](/assets/images/2020-12-21/11.png)  
우선, 할당된 IPv4주소인 3.35.46.177을 클릭한다.  
![png](/assets/images/2020-12-21/12.png)  
그럼 이런 페이지가 뜬다. "탄력적 IP주소 연결"을 클릭한다.  
![png](/assets/images/2020-12-21/13.png)  
인스턴스를 현재 내가 생성한 인스턴스로 선택해준다.  
"연결"을 클릭한다.  
![png](/assets/images/2020-12-21/14.png)  
![png](/assets/images/2020-12-21/15.png)  
다음과 같이 현재 연결되 인스턴스 ID를 확인할 수 있다. 
![png](/assets/images/2020-12-21/16.png)  
...
![png](/assets/images/2020-12-21/17.png)  
AWS가이드 보는 방법! 인스턴스에서 마우스 우클릭 후 "연결" 클릭하면 나온다.  
![png](/assets/images/2020-12-21/18.png)  
이렇게!  
...
![png](/assets/images/2020-12-21/19.png)  
...
![png](/assets/images/2020-12-21/20.png)  
VS Code 왼쪽 하단에 있는 초록색 >< 버튼을 클릭한다.  
![png](/assets/images/2020-12-21/21.png)  
맨 위의 Remote-SSH: Connect Current Window to Host...를 클릭한다.  
![png](/assets/images/2020-12-21/22.png)  
...
![png](/assets/images/2020-12-21/24.png)  
...
![png](/assets/images/2020-12-21/25.png)  
