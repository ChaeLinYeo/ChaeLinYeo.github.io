...
### 예제: 주변확률(Marginal)분포, 조건부(Conditional)확률분포
두개의 확률변수 $X, Y$가 있다고 가정하자. 
![png](/assets/images/2021-01-04/10.png)  
<br>
...
$J = \begin{bmatrix}
{\partial x_1} \above 1pt {\partial y_1} & {\partial x_1} \above 1pt {\partial y_2} & \ldots & {\partial x_1} \above 1pt {\partial y_k}\\ 
...
![png](/assets/images/2021-01-04/12.png)  
<br>
