...
python3 manage.py runserver해서 실행한 뒤 http://127.0.0.1:8000/admin/에 접속하면 다음과같이 Coffee 모델이 뜨는 것을 확인할 수 있다.  
...
form을 작성하는 것은 형태가 정해져 있기 때문에, 한번 익혀두면 응용해 쓰기 편하다.  
```python
