...
* CLCU(CleaningCurator) AndroidApp
    ...
    * 디자이너들과 협업하여 개발한 집안 청소 스케줄링 및 도우미 앱
...
* Pet CCTV Robot
    ...
    * 사용자가 설정한 위험 구역에 반려동물이 진입하였을시 AI로 감지하여 앱으로 푸시 알림을 주고 로봇에서 음성이 송출되어 반려동물을 저지한다.
    [Youtube](https://www.youtube.com/watch?v=xgkCvGvINPU&t=25s)
